...
2026-09-19：正式部署 de7b31617688e7f2d258e01d036cb7bba5b829a6。CI 35450399143 成功，44项浏览器回归通过；发布前完成数据库备份。线上核验公开画像首页HTML与canonical、私人领取页noindex/no-store、sitemap、三篇教程与图片、SEO管理匿名401全部通过。
